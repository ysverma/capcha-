...
if(isset($_POST['submit'])){
    ...
    function post_captcha($user_response) {
        $fields_string = '';
        $fields = array(
            'secret' => '6Lc3W9kZAAAAAGaIOqv8WkgI6Dt2VFmRr98kO-bA',
...
if($recaptcha['success'] && $_POST['url'] == "") {
...
<form name="form1" id="form1" action=""  method="post"  onSubmit="return form_validate(this);">
			<table width="620" align="center"  border="0" cellpadding="2" cellspacing="2">
                ...
                <tr>
                <td colspan="2" align="right" class="black_para" style=" text-align: center; padding-left:50px;"><font color="#cc0000">*</font>Mark fields are required.</td>
              </tr>
                <tr>
              ...
              <tr><td width="233"><input type="text" name="url" id="url" style="display:none;"></td></tr>
              <tr><td></td>
              <td class="black_para">
                      <div class="g-recaptcha" data-sitekey="6Lc3W9kZAAAAAIsoe33wZHgtdDWTChLtgzGgCSEL" style="transform:scale(0.85);-webkit-transform:scale(0.85);transform-origin:0 0;-webkit-transform-origin:0 0;"></div>
              </td>
              <tr>
